  ...
  return (
    <>
      <div className="about-text">
        ...
        <img src="https://beardedgentlemenmusic.com/wp-content/uploads/2016/02/Daughter-New-Album.jpg" id="img-band" alt="Image of the band members in Daughter"  height="500px"/>
